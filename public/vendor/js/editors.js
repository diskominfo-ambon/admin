  ...
  NioApp.Tinymce = function () {
    ...
    if ($(_tinymce_inline).exists()) {
      ...
      tinymce.init({
        ...
        toolbar: ['undo redo | bold italic underline | link image fontsizeselect', 'forecolor backcolor | alignleft aligncenter alignright alignfull | numlist bullist outdent indent']
      });
    }
  }; // Quill Init @v1.0
